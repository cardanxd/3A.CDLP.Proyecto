...
namespace WorkIO.Services.Migrations
{
    ...
    [Migration("20200620032724_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkIO.Models.Documentos", b =>
                {
                    b.HasOne("WorkIO.Models.Candidato", "Candidato")
                        .WithOne("Documento")
                        .HasForeignKey("WorkIO.Models.Documentos", "CandidatoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WorkIO.Models.Orden", b =>
                {
                    b.HasOne("WorkIO.Models.Empresa", null)
                        .WithMany("Orden")
                        .HasForeignKey("EmpresaId");
                });
            ...
            modelBuilder.Entity("WorkIO.Models.Referencia", b =>
                {
                    b.HasOne("WorkIO.Models.Candidato", "Candidato")
                        .WithOne("Referencia")
                        .HasForeignKey("WorkIO.Models.Referencia", "CandidatoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
